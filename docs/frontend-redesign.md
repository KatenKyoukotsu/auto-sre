...
Статус: фазы 1–5 готовы. Фаза 6 опциональна. Каждая фаза независимо
...
5. **Анимации**: typewriter-для-новых (sessionStorage seen-set, клик — пропуск,
   reduced-motion — отключено), stagger `--i`, плавный ack — ✅
